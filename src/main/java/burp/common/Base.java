...
public interface Base {
    ...
    public static HttpHeader header = HttpHeader.httpHeader("User-Agent","Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.5414.75 Safari/537.36");
    ...
    static HttpRequestResponse sendRequest(String url, String method, String body, List<HttpHeader> header){
        ...
        if (body != null) httpRequest = httpRequest.withBody(body).withAddedHeader(Base.header);
